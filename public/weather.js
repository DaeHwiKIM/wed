...
function getSelectedCityWeather(selectedCity) {
...
function getWeather(lat, lon) {
  ...
  $.getJSON(weatherUrl, function (weatherData) {
    ...
    $.getJSON(forecastUrl, function (forecastData) {
      ...
      let outfitImage;
      if (temperature < 5) {
        outfitImage = "images/outfit4.png";
      } else if (temperature < 9) {
        outfitImage = "images/outfit5-8.png";
      } else if (temperature < 12) {
        outfitImage = "images/outfit9-11.png";
      } else if (temperature < 17) {
        outfitImage = "images/outfit12-16.png";
      } else if (temperature < 20) {
        outfitImage = "images/outfit17-19.png";
      } else if (temperature < 23) {
        outfitImage = "images/spring_outfit20-22.png";
      } else if (temperature < 28) {
        outfitImage = "images/outfit23-27.png";
      } else {
        outfitImage = "images/outfit28.png";
      }
      $("#outfit").attr("src", outfitImage);
    });
  });
}
    ...
    for (let i = 0; i < hourly_forecast.length; i++) {
      ...
      if (selected_hours.includes(hour)) {
        ...
        <li>
          ...
          <img src="${outfitImage}" alt="Clothes image">
        </li>
      `;
